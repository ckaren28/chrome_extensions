...
var createNewTaskElement = function(taskString) {
  ...
  // class
  var idName = document.createElement("id");
  //input (checkbox)
...
var addTask = function() {
  ...
  var key = taskInput.value;
  localStorage.setItem(key,  'item');
  var newlistJSON = localStorage.getItem(key)
